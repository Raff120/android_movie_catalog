...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        val sharedPreferences = requireContext().getSharedPreferences("language_preferences", Context.MODE_PRIVATE)
        ...
        sp_editor.putString("app_language", getString(R.string.empty_string))
        sp_editor.apply()

        if(app_language==getString(R.string.empty_string)){
            ...
            if(app_language == "it") italianCheckBox?.let { it.isChecked = true }
            else englishCheckBox?.let { it.isChecked = true }
        }
